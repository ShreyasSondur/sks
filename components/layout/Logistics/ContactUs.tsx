...
export default function ContactUs() {
    ...
    const features = [
        "Free supply chain health check available",
        "Regional coverage with end-to-end delivery",
        "Expert customs & government liaising support",
        "Tailored logistics solutions for every client",
    ];
                    ...
                    <div className="lg:w-[42%] bg-brand-navy p-8 md:p-10 flex flex-col justify-between shadow-xl rounded-sm">
                        <div>
                            ...
                            <p className="text-white/40 font-barlow text-[14px] leading-relaxed mb-8">
                                Our logistics specialists are ready to analyze your supply chain and recommend the most efficient, cost-effective solutions for your business.
                            </p>
                    ...
                    <div className="lg:w-[58%] bg-[#F8FAFC] p-8 md:p-10 shadow-lg border border-gray-100/50 rounded-sm">
                        {isSuccess ? (
                            <div className="h-full flex flex-col items-center justify-center text-center py-20">
                                ...
                                <p className="text-brand-navy/60 font-barlow mb-10">We have received your logistics enquiry and will be in touch within 24 hours.</p>
                                <button
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div className="space-y-2">
                                    <label className="text-brand-navy font-barlow-condensed font-bold text-[11px] tracking-[0.05em] uppercase">Logistics Requirement</label>
                                    <textarea
                                        name="requirement"
                                        value={formData.requirement}
                                        onChange={handleChange}
                                        rows={4}
                                        placeholder="e.g., End-to-end delivery for retail products across the GCC, including warehouse storage and customs clearance..."
                                ...
                                >
                                    {isSubmitting ? "Processing..." : "Submit Logistics Enquiry —"}
                                </button>
                            </form>
                        )}
                    </div>
