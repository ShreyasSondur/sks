...
const NAV_ITEMS: NavItem[] = [
    { label: "HOME", href: "/" },
    {
        ...
        href: "/services",
        dropdown: [
            { label: "SKAR Security & Cash Services", href: "/Security" },
            { label: "SKAR Facilities Management", href: "/Facilities" },
            { label: "SKS Logistics & Supply Chain", href: "/Logistics" },
        ],
    },
        ...
        >
            ...
            <nav className="mx-auto flex items-center justify-between px-6 md:px-10 lg:px-14" style={{ height: "60px" }}>
                ...
                <div className="hidden lg:flex items-center gap-3">
                    <Link
                        href="#contact"
                        className="px-7 py-2.5 text-[10px] tracking-[0.18em] text-[var(--brand-yellow)] hover:text-[var(--brand-navy)] hover:bg-[var(--brand-yellow)] transition-all duration-200 rounded-[10px] whitespace-nowrap"
                        style={{
                            border: "1.2px solid var(--brand-yellow)",
                            fontFamily: "var(--font-barlow), sans-serif",
                            fontWeight: 600,
                        }}
                    >
                    ...
                    <Link
                        href="/skar"
                        className="px-7 py-2.5 text-[10px] tracking-[0.18em] text-[var(--brand-navy)] bg-[var(--brand-yellow)] hover:bg-[#e6a800] transition-colors duration-200 rounded-[10px] whitespace-nowrap"
                        style={{
                            fontFamily: "var(--font-barlow), sans-serif",
                            fontWeight: 600,
                        }}
                ...
                <div className="px-6 py-4">
                    ...
                    <div className="flex flex-col gap-3 mt-5">
                        <Link
                            ...
                            className="text-center px-5 py-2.5 text-[10px] tracking-[0.18em] text-[var(--brand-yellow)] hover:text-[var(--brand-navy)] hover:bg-[var(--brand-yellow)] transition-all duration-200 rounded-[10px]"
                            style={{
                                border: "1.2px solid var(--brand-yellow)",
                                fontFamily: "var(--font-barlow), sans-serif",
                                fontWeight: 600,
