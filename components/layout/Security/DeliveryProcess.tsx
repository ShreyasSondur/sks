...
const steps = [
    {
        ...
        description: "Comprehensive evaluation of your premises, vulnerabilities, and specific security requirements."
    },
    {
        number: "2",
        title: "Personnel Briefing & Assignment",
        description: "Certified teams briefed on site protocols, access procedures, and emergency response requirements."
    },
    {
        number: "3",
        title: "Deployment & Activation",
        description: "Trained security personnel deployed and activated across all assigned posts and responsibilities."
    },
    {
        number: "4",
        title: "Ongoing Monitoring & Reviews",
        description: "Regular performance reviews, incident reports, and quality checks to maintain standards continuously."
    }
];
                ...
                <div className="flex flex-col lg:flex-row items-center justify-between gap-16 lg:gap-64">
                    ...
                    <div className="w-full lg:w-[30%] text-left lg:mr-32">
                        ...
                        <p className="text-white/50 font-barlow text-[16px] leading-relaxed max-w-sm">
                            Our security deployment follows a structured methodology to ensure zero gaps in protection from day one.
                        </p>
                    </div>
