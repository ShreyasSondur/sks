...
const steps = [
    {
        number: "1",
        title: "Facilities Requirements Assessment",
        description: "Complete review of your facility needs, staffing requirements, and scope of services required."
    },
    {
        number: "2",
        title: "Team Selection & Briefing",
        description: "Appropriate FM personnel selected, vetted, and briefed on all site-specific protocols."
    },
    {
        number: "3",
        title: "Service Deployment",
        description: "Teams mobilized and all services activated according to the agreed schedule and scope of work."
    },
    {
        number: "4",
        title: "Performance Reviews & Quality Checks",
        description: "Regular quality checks with documented action points ensuring continuous service excellence."
    }
];
                ...
                <div className="flex flex-col lg:flex-row items-center justify-between gap-16 lg:gap-64">
                    ...
                    <div className="w-full lg:w-[30%] text-left lg:mr-32">
                        ...
                        <p className="text-white/50 font-barlow text-[16px] leading-relaxed max-w-sm">
                            Our FM onboarding ensures a seamless transition with zero disruption to your day-to-day operations.
                        </p>
                    </div>
